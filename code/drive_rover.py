...
from collections import deque # for storing acceleration (i.e., history/queue of velocities)
...
class RoverState():
    def __init__(self):
        ...
        self.throttle_set = 0.1 #.2 # Throttle setting when accelerating
        self.brake_set = 100 # Brake setting when braking
        ...
        self.max_vel = 5 #2 # Maximum velocity (meters/second)
        ...
        self.accel = deque([], self.stop_forward) # acceleration - history/queue of velocities
